...
namespace EasyAbp.EzGet
{
    ...
    public class EzGetWebHostModule : AbpModule
    {
        public override void PreConfigureServices(ServiceConfigurationContext context)
        {
            context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
            {
                options.AddAssemblyResource(
                    ...
                    typeof(EzGetDomainSharedModule).Assembly,
                    typeof(EzGetCommonApplicationContractsModule).Assembly,
                    typeof(EzGetWebHostModule).Assembly
                );
            });
        }
        ...
        private void ConfigureMenu(IConfiguration configuration)
        {
            ...
            {
                options.MenuContributors.Add(new EzGetWebHostMenuContributor(configuration));
            });
        }
        ...
        private void ConfigureAutoMapper()
        {
            ...
            {
                options.AddMaps<EzGetWebHostModule>();
            });
        }
            ...
            IWebHostEnvironment hostingEnvironment)
        {
            if (!hostingEnvironment.IsDevelopment())
            {
                ...
                context.Services
                    .AddDataProtection()
                    .PersistKeysToStackExchangeRedis(redis, "EzGet-Protection-Keys");
            }
        }
        ...
        public override void OnApplicationInitialization(ApplicationInitializationContext context)
        {
            ...
            {
                options.SwaggerEndpoint("/swagger/v1/swagger.json", "EzGet API");
            });
