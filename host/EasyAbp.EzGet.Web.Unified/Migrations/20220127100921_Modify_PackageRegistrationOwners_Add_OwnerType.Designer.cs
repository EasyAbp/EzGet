...
namespace EasyAbp.EzGet.Migrations
{
    ...
    [Migration("20220127100921_Modify_PackageRegistrationOwners_Add_OwnerType")]
    partial class Modify_PackageRegistrationOwners_Add_OwnerType
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EasyAbp.EzGet.NuGet.Packages.NuGetPackage", b =>
                {
                    ...
                    b.Property<Guid>("PackageRegistrationId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EasyAbp.EzGet.NuGet.Packages.PackageDependency", b =>
                {
                    ...
                    b.Property<string>("DependencyPackageName")
                        .HasMaxLength(128)
                        .HasColumnType("nvarchar(128)");
            ...
            modelBuilder.Entity("EasyAbp.EzGet.PackageRegistrations.PackageRegistration", b =>
                {
                    ...
                    b.HasIndex("PackageName", "PackageType", "FeedId")
                        .IsUnique()
            ...
            modelBuilder.Entity("EasyAbp.EzGet.PackageRegistrations.PackageRegistrationOwner", b =>
                {
                    b.Property<Guid>("PackageRegistrationId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("PackageRegistrationId", "UserId");

                    b.ToTable("EzGetPackageRegistrationOwners", (string)null);
                });
            ...
            modelBuilder.Entity("EasyAbp.EzGet.Credentials.CredentialScope", b =>
                {
                    b.HasOne("EasyAbp.EzGet.Credentials.Credential", null)
                        .WithMany("Scopes")
            ...
            modelBuilder.Entity("EasyAbp.EzGet.Feeds.FeedCredential", b =>
                {
                    b.HasOne("EasyAbp.EzGet.Feeds.Feed", null)
                        .WithMany("FeedCredentials")
            ...
            modelBuilder.Entity("EasyAbp.EzGet.NuGet.Packages.PackageDependency", b =>
                {
                    b.HasOne("EasyAbp.EzGet.NuGet.Packages.NuGetPackage", null)
            ...
            modelBuilder.Entity("EasyAbp.EzGet.PackageRegistrations.PackageRegistrationOwner", b =>
                {
                    b.HasOne("EasyAbp.EzGet.PackageRegistrations.PackageRegistration", null)
                        .WithMany("PackageRegistrationOwners")
            ...
            modelBuilder.Entity("EasyAbp.EzGet.PackageRegistrations.PackageRegistration", b =>
                {
                    b.Navigation("PackageRegistrationOwners");
                });
