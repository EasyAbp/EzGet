...
namespace EasyAbp.EzGet.Migrations
{
    ...
    [Migration("20211116040030_Modify_Feed_Add_UserId")]
    partial class Modify_Feed_Add_UserId
    {
            ...
            modelBuilder.Entity("EasyAbp.EzGet.NuGet.Packages.NuGetPackage", b =>
                {
                    ...
                    b.HasIndex("PackageName", "NormalizedVersion", "FeedId")
                        .IsUnique()
                        .HasFilter("[PackageName] IS NOT NULL AND [NormalizedVersion] IS NOT NULL AND [FeedId] IS NOT NULL");
